...
$recdescricao= filter_input(INPUT_POST, 'descricao');
  ...
  if(mysqli_query($conn, "UPDATE tb_projetos SET projetos='$rectipo', arquiteto_responsavel='$recarquiteto_responsavel', estilo_de_projeto='$recestilo_de_projeto', orcamento='$recorcamento', prazo_entrega='$recprazo_entrega', cliente='$reccliente', descricao='$recdescricao' WHERE id_projetos=$recid")) {
